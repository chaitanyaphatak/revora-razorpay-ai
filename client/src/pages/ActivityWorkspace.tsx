      ...
      <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded-full border border-teal-200/80 bg-teal-50 px-3 py-1 text-xs font-semibold text-teal-800 shadow-2xs">
            ...
            <span className="text-teal-700">Immutable Log</span>
          </div>
          <h1 className="mt-3 text-3xl font-extrabold tracking-tight text-slate-950 sm:text-4xl sm:leading-tight">
            ...
            <span className="bg-gradient-to-r from-teal-600 via-indigo-600 to-violet-600 bg-clip-text text-transparent">
              Policy Governance Trail
            </span>
          </h1>
          <p className="mt-2.5 text-sm leading-relaxed text-slate-600 sm:text-base">
            Review timestamped policy decisions, synthetic manual interventions, and verifiable cryptographic checkout events in real-time.
          </p>
        ...
        <Button onClick={() => refetch()} variant="outline" className="self-start rounded-xl border-slate-200 bg-white shadow-sm lg:self-center">
          {isFetching ? <RefreshCw className="rr-execution-spinner mr-2 h-4 w-4" /> : <RefreshCw className="mr-2 h-4 w-4" />}
          {isFetching ? "Refreshing…" : "Refresh Activity"}
        </Button>
      </div>
    </section>
